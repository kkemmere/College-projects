...
public class LineGraph extends Applet {
		...
		public LineGraph() throws FileNotFoundException
		{
		...
		public void paint(Graphics g)
		{
		   ...
		   //  int height = this.getHeight();
	    	...
	    	for(int i = 0; i < data.length; i++)
	    	{
	    		g.drawLine((i+1) * 30+5,(int) (height-30 - data[i]*lineratio),((i+1) * 30+5),(int) (height-30 - data[i]*lineratio));
	    		g.drawString(data[i]+"", ((i+1)*30)-5, height);
	    	}
